...
impl Project {
    ...
    pub async fn remote(
        ...
        let project = Self::in_room(remote_id, client, languages, fs, cx.clone()).await?;
        cx.update(|cx| {
    ...
    pub async fn in_room(
        ...
        let response = client
            ...
            .await?;
        Self::from_join_project_response(response, subscriptions, client, false, languages, fs, cx)
            .await
    }
