...
impl SshRemoteConnection {
    ...
    async fn ensure_server_binary(
        ...
        // Check server in PATH
        {
            let binary_name = format!("zed-remote-server-{}", release_channel.dev_name());
            let dst_path = RemotePathBuf::new(PathBuf::from(binary_name), self.ssh_path_style);
